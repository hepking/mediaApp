...
- (void)viewDidLoad
{
    ...
    if((self.edgesForExtendedLayout =_MainVC.edgesForExtendedLayout)){
    ...
    //滑动手势
    _panGestureRec = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(PancloseSideBar:)];
...
- (void)PancloseSideBar:(UIPanGestureRecognizer *)panGes
{
